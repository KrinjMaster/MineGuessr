...
<div class="navbar flex items-center justify-between bg-base-100 bg-opacity-25 fixed backdrop-blur-3xl text-white px-5 z-[100]">
  ...
  <div class="flex gap-2.5">
    <div class="dropdown dropdown-hover dropdown-end">
      <label tabindex="-1" class={`m-1 btn btn-outline ${isInGame ? "btn-neutral" : "btn-secondary"}`} for="langs">
      ...
      <ul id="langs" tabindex="-1" class="dropdown-content z-[1] menu menu-lg p-2 shadow bg-base-200 rounded-box w-44 gap-1.5">
    ...
    <div class="dropdown dropdown-hover dropdown-end">
      <label tabindex="-1" class={`m-1 btn btn-outline ${isInGame ? "btn-neutral" : "btn-secondary"}`} for="themes">{$t("menu.theme")}</label>
      <ul id="themes" tabindex="-1" class="dropdown-content z-[1] menu menu-lg p-2 shadow bg-base-200 rounded-box w-fit gap-1.5">
    ...
    <!-- github logo -->
    <a href="https://github.com/KrinjMaster/MineGuessr" target="_blank" rel="noopener noreferrer">
